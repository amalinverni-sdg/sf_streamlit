...
#     # Check if the user input matches the condition to navigate to the update page
#     if function_option == "Edit":
#         # Create a URL for the update page
#         update_url = f"{st.get_option('browser.serverAddress')}?page=update"
#         # Redirect to the update page
#         raise RerunException(ScriptRequest(update_url))

#     # Check query parameters to see if we should navigate to the update page
